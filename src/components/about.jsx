const About = ()=>{
    return(
        <div className="flex sm:flex-row flex-col justify-center items-center h-[60vh] w-full text-white sm:gap-2 gap-4">
            <div className="flex justify-center items-center sm:w-[40%] w-full sm:order-2 order-1">
