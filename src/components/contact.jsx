        ...
        <div className="w-full text-white flex flex-col items-center lg:pt-12 md:pt-10 pt-8 gap-4 fade-in">
            {
                ...
                : <>
                    <h2 className="text-center font-bbbFont text-3xl sm:text-4xl lg:text-5xl mb-2 text-cyan-500">Contact Me</h2>
                    <div className='w-full rotate-1 rounded-lg border border-cyan-500'>
                        <div className='w-full -rotate-2 rounded-lg border border-cyan-500'>
                            <div className='w-full -rotate-1 rounded-lg border border-cyan-500'>
                                <div className='w-full rotate-[4deg] border border-cyan-500 rounded-lg'>
                                    <form className={`w-full bg-gray-800 lg:p-8 md:p-6 sm:p-5 p-4 rounded-lg -rotate-2`} onSubmit={handleSubmit}>
