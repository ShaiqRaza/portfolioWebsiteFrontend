                ...
                <div>
                    {
                        ...
                        :
                        <div className='lg:pt-[17vh] sm:pt-[16vh] pt-[13vh] h-[80vh] w-full flex justify-center items-center bg-gray-900 text-white'>I have <span className='text-cyan-500'> no projects </span> yet.</div>
                    }
                </div>
                :
