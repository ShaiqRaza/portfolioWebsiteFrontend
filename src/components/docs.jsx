                ...
                <div>
                    {
                        ...
                        <div className="lg:pt-[17vh] sm:pt-[16vh] pt-[13vh] bg-gray-900 flex flex-col gap-5">
                            ...
                            <Masonry className="px-[4vw] w-full min-h-[70vh] h-auto flex justify-center gap-2" breakpointCols={breakpointColumns}>
                                {
                                    docs?.map(doc=>{
                                        return (
                        ...
                        <div className="h-[80vh] w-full flex justify-center items-center lg:pt-[17vh] sm:pt-[16vh] pt-[13vh] text-white bg-gray-900">
                            <h1>No <span className="text-cyan-500">documents</span> available.</h1>
                        </div>
                    }
                </div>
                : 
                <div className='h-[80vh] w-full flex justify-center items-center lg:pt-[17vh] sm:pt-[16vh] pt-[13vh] bg-gray-900'>
                    <Box>
                        <CircularProgress />
                    </Box>
                </div>
